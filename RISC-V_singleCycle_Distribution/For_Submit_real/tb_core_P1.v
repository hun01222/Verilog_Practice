...
1.1.
    ...
    mem[ 4] = 32'h01DE8D33; // add   x26,x29,x29 0000000 11101 11101 000 11010 0110011
    ...
    mem[28] = 32'h000D0C03; // lw    x24,0(x26) 000000000000 11010 000 11000 0000011
    mem[32] = 32'h000D8C83; // lw    x25,0(x27)
    mem[36] = 32'h419C1C33; // mul   x24,x24,x25 0100000 11001 11000 001 11000 0110011
    mem[40] = 32'h018F8FB3; // add   x31,x31,x24
    mem[44] = 32'h001F0F02; // addi  x30,x30,1

    mem[48] = 32'h01EB8263; // beq   x30,x23,0
    mem[52] = 32'h01FE8007; // sw    x29,0(x31) 0000000 11111 11101 000 00000 0000111
